...
export const useMainStore: StoreDefinition = defineStore("main", () => {
  ...
  const hints: Ref<NumberIndexedObject> = ref({
    1: [
      ...
      "<i><b>format</b> 버튼을 누르면 <b>JSON</b> 포맷으로 변경해줍니다.</i>",
      "<i><b>제출</b>을 클릭해보세요.(또는 Ctrl+Enter를 입력하세요.)</i>"
    ],
    2: [
      ...
      "<i><b>match</b> 쿼리로 <b>customer_full_name</b> 필드가 <b>Bailey</b>인 문서를 검색하세요. </i>"
    ],
    3: [
      ...
      "<i><b>customer_full_name.keyword</b>를 이용하여 <b>customer_full_name</b> 필드가 <b>Eddie Underwood</b>인 문서를 검색하세요.</i>"
    ],
    4: [
      ...
      "<b>gt</b> : 초과, <b>lt</b> : 미만",
      "<i><b>taxful_total_price</b> 필드의 값이 <b>100 이상</b>인 문서를 검색하세요.</i>"
    ],
    5: [
      ...
      "<i><b>customer_full_name</b> 필드에서 <b>Mary</b>가 포함되어 있으면서 <b>Bailey</b>는 포함되지 않는 문서를 검색하세요.</i>"
    ],
    6: [
      ...
      "<i><b>email</b> 필드의 값이 정확히 <b>gwen@butler-family.zzz</b>이면서 <b>taxful_total_price</b> 필드 값이 <b>100 이상</b>인 문서를 검색하세요.</i>"
    ],
    7: [
      ...
      "<i>1. <b>customer_full_name</b> 필드 값이 <b>Oliver Rios</b> 이거나</i>",
      "<i>2. <b>day_of_week</b> 필드값이 <b>Monday</b>이거나</i>",
      "<i>3. <b>taxful_total_price</b> 필드의 값이 <b>1000 초과</b></i>",
      "<i> 위 조건중 2개이상을 만족하는 문서를 검색하세요.</i>"
    ],
    8: [
      ...
      "<i>1.<b>total_quantity</b> 값이 <b>4 이상</b>이거나</i>",
      "<i>2.<b>taxful_total_price</b>의 값이 <b>200 이상</b>이면서 <b>day_of_week</b>가 <b>Monday</b>인 문서</i>",
    ...
    9: [
      ...
      "<i><b>manufacturer</b> 필드의 값이 <b>Elitelligence</b> 또는 <b>Pyramidustries</b>인 문서를 검색하세요</i>"
    ],
    10: [
      "<b>Wildcard 쿼리를 사용하면 패턴 매칭을 통해 검색</b>을 수행할 수 있습니다.",
      "예를 들어, 텍스트의 일부만 알고 있을 때, <b>*</b>나 <b>?</b>와 같은 와일드카드 문자를 사용하여 검색할 수 있습니다.",
      "<i><b>user</b> 필드의 값이 <b>r</b>로 시작하면서 중간에 <b>bb</b>가 들어간 문서를 검색하세요</i>"
    ],
    11: [
      ...
      "<i><b>email</b> 필드가 있는 문서를 검색하세요.</i>"
    ],
    12: [
      "<b>multi_match 쿼리는 여러 필드에서 동시에 검색어에 대해 검색</b>합니다.", "이는 하나의 검색어를 다양한 필드에서 찾고 싶을 때 사용되며, 여러 필드에 걸쳐 있는 정보를 통합적으로 검색할 수 있게 해줍니다.",
      "<i><b>customer_first_name</b>, <b>customer_last_name</b>, <b>email</b> 필드 중에서 <b>Eddie</b> 값을 포함하는 문서를 검색하세요.</i>"
    ],
    13: [
    ...
    14: [
      ...
      "<i><b>customer_</b>으로 시작하는 필드는 포함하지만, <b>_id</b>로 끝나는 필드는 검색결과에 포함되지 않도록 검색하세요</i>"
    ],
    15: [
      ...
      "<i><b>order_date</b> 필드를 기준으로 내림차순으로 정렬해서 검색하세요.</i>"
    ],
    16: [
      ...
      "<i>챕터 16부터는 문제가 아니라 <b>기능설명</b>입니다!</i>"
    ],
    17: [
